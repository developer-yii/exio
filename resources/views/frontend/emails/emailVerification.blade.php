...
@component('mail::button', ['url' => route('verify-account', $user->remember_token), 'color' => 'primary'])
...
[{{ route('verify-account', $user->remember_token) }}]({{ route('verify-account', $user->remember_token) }})
                    ...
                    <tr>
                        <td class="header"
                            ...
                            <a href=""
                                ...
                                Thank you for Registration on {{ config('app.name') }}!
                            </a>
                        </td>
                    </tr>
