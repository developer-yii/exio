                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label for="city_name" class="form-label">Name<span
                                            class="text-danger add_edit_required">*</span></label>
                                    <input type="text" name="city_name" class="form-control city_name" value="">
...
@section('js')
    <script>
        var apiUrl = "{{ route('admin.city.list') }}";
        var detailUrl = "{{ route('admin.city.detail') }}";
        var addUpdateUrl = "{{ route('admin.city.addupdate') }}";
        var deleteUrl = "{{ route('admin.city.delete') }}";
    </script>
@endsection

@section('pagejs')
    <script src="{{ addPageJsLink('city.js') }}"></script>
@endsection
