...
@section('content')
    ...
    <div class="row mt-3 mb-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2">
            <select class="form-select filter_city_id" id="filter_city_id" name="filter_city_id">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mb-3">
                                    <label for="location_name" class="form-label">Name<span
                                            class="text-danger add_edit_required">*</span></label>
                                    <input type="text" name="location_name" class="form-control location_name" value="">
                                    <span class="error"></span>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <table class="table table-centered mb-0" id="information">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span class="location_name"></span></td>
                                    </tr>
                                    <tr>
...
@section('js')
    <script>
        var apiUrl = "{{ route('admin.location.list') }}";
        var detailUrl = "{{ route('admin.location.detail') }}";
        var addUpdateUrl = "{{ route('admin.location.addupdate') }}";
        var deleteUrl = "{{ route('admin.location.delete') }}";
        var getAllCitiesUrl = "{{ route('admin.common.cities.all') }}";
    </script>
@endsection

@section('pagejs')
    <script src="{{ addPageJsLink('location.js') }}"></script>
@endsection
